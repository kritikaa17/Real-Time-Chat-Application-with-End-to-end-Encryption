...
const Step1 = () => {
  ...
  return (
    <>
      <Typography text="What is the name of your group" className="my-4" />

      <Typography
        text="This will be the name of your Chati group - choose something that your friends will recognize."
...
const Step2 = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (error?.error) {
      console.log(error);
      return toast.error("Couldn't create group. Please try again.");
    }
  ...
  return (
    <>
      ...
      <form action="">
        <Typography text="Add group avatar" className="my-4" />
        <Typography
          text="This image can be changed later in your group settings"
          className="text-neutral-300"
          variant="p"
        />
        <fieldset
