        ...
        <Tabs orientation="horizontal" defaultValue="themes">
          ...
          <TabsContent className="max-w-xs md:max-w-fit" value="themes">
            ...
            <Typography
              variant="p"
              className="pb-4"
              text="Choose if Chati appearance should be light or dark, or follow the computer settings"
            />
            ...
            <div className="flex flex-wrap gap-5">
              ...
              <Button
                ...
                className="w-full hover:border-teal-800 border-2"
              >
                Teal
              </Button>
              <Button
                ...
                className="w-full hover:border-orange-800 border-2"
              >
                Orange
              </Button>
