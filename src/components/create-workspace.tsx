...
const CreateWorkspace = () => {
  ...
  const formSchema = z.object({
    name: z.string().min(2, {
      message: "Group name should be at least 2 characters long",
    }),
  });
    ...
    >
      <DialogTrigger asChild>
        <div className="flex items-center gap-2 p-2">
          ...
          <Typography variant="p" text="Add Group" />
        </div>
      </DialogTrigger>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="my-4">
            <Typography variant="h4" text="Create Group" />
          </DialogTitle>
        </DialogHeader>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    <Typography variant="p" text="This is your Group name" />
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
